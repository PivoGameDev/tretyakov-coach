...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const menuText = {
    ...
    th: { trainer: 'โค้ช', skating: 'น้ำแข็ง', ofp: 'GPP', sfp: 'SPP', online: 'Online', contacts: 'ติดต่อ', 'video-title': 'วิดีโอการกระโดด', 'video-4s': '4S (Salchow สี่รอบ)', 'video-3lz': '3Lz (Lutz สามรอบ)', 'career-title': 'ผลงานอาชีพ', 'footer-copy': '© 2026 โค้ชสเก็ตลีลา', 'medal-1': 'การแข่งขัน Moscow City Championship «Olympic Hopes» — 2005', 'medal-2': 'Russian Cup Final — 2009, ตเวียร์', 'medal-3': 'Nebelhorn Trophy — 2009, โอเบอร์สตอร์ฟ (เยอรมนี)', 'medal-4': 'NRW Trophy — 2010, ดอร์ทมุนด์ (เยอรมนี)', 'medal-5': 'ISU JGP Tallinn Cup — 2005, ทัลลินน์ (เอสโตเนีย)', 'medal-6': 'NRW Trophy — 2007, ดอร์ทมุนด์ (เยอรมนี)' }
  };
